...
VALUES (1, '订单详情', 'POST:/order/info', '2021-02-02 14:16:07', '2021-06-16 22:25:24');
...
VALUES (1, '超级管理员', 'ROOT', 1, '2021-05-21 14:56:51', '2018-12-23 16:00:00');
INSERT INTO `sys_role`
VALUES (2, '系统管理员', 'ADMIN', 1, '2021-03-25 12:39:54', '2018-12-23 16:00:00');
INSERT INTO `sys_role`
VALUES (3, '访问用户', 'GUEST', 1, '2021-05-26 15:49:05', '2019-05-05 16:00:00');
...
(
    ...
    `locked`       tinyint NOT NULL COMMENT ' 账号锁定状态 1-锁定 0-未锁定',
    `expired_time` datetime                                                DEFAULT NULL COMMENT '账号到期时间',
    `enabled`      tinyint NOT NULL COMMENT '账号是否开启 1-开启 0-关闭',
